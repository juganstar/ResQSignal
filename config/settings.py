"""
Django settings for LiveSignal project.
...
REST_AUTH = {
    "USE_JWT": False,
    "SESSION_LOGIN": True,  # Changed from True for better security
...
# Optional (only used if you enable sandbox mode for development)
SENDGRID_SANDBOX_MODE_IN_DEBUG = DEBUG
SENDGRID_ECHO_TO_STDOUT = False
ACCOUNT_EMAIL_SUBJECT_PREFIX = "[LiveSignal] "
